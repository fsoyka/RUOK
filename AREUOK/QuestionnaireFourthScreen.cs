...
namespace AREUOK
{
	...
	public class QuestionnaireFourthScreen : Activity
	{
		protected override void OnCreate (Bundle bundle)
		{
			...
			SetContentView (Resource.Layout.QuestionnaireFourthScreen);
			...
			ganzeZeit.Click += delegate {
				...
				Intent intent = new Intent(this, typeof(QuestionnaireFifthScreen));
