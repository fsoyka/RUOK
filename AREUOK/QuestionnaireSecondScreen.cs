...
namespace AREUOK
{
	...
	public class QuestionnaireSecondScreen : Activity
	{
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			SetContentView (Resource.Layout.QuestionnaireSecondScreen);
			...
			ganzeZeit.Click += delegate {
				...
				Intent intent = new Intent(this, typeof(QuestionnaireThirdScreen));
