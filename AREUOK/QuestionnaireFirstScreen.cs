...
namespace AREUOK
{
	...
	public class QuestionnaireFirstScreen : Activity
	{
		int Ergebnis = 0;
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			// Set our view to the layout resource
			SetContentView (Resource.Layout.QuestionnaireFirstScreen);

			//in the beginning the score is 0
			...
			ganzeZeit.Click += delegate {
				...
				Intent intent = new Intent(this, typeof(QuestionnaireSecondScreen));
